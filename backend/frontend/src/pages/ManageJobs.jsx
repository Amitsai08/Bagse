...
const ManageJobs = () => {
    const {
        ...
        queryFn: () =>
            getAllHandler(
                `https://bankagentbridge.onrender.com/api/v1/jobs/my-jobs`
            ),
    });
    ...
    const deleteJobHandler = async (id) => {
        try {
            const response = await axios.delete(
                `https://bankagentbridge.onrender.com/api/v1/jobs/${id}`,
            ...
            // setJobs(updateJobs);
            // handleJobFetch(
            //     `https://bankagentbridge.onrender.com/api/v1/jobs?page=1`
            // );
            refetch();
            Swal.fire({
                title: "Deleted!",
